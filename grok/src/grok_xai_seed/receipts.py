...
def issue_receipt(
    ...
    receipt = {
        "schema": "vaultsovereign.grok.receipt.v1",
        "receipt_id": "rcpt_grok_" + hashref_json(run).split(":", 1)[1][:16],
        "issued_at": utc_now(),
        "claim": {
            "type": "grok_task_policy_checked_and_execution_evidence_recorded",
...
def verify_receipt(
    ...
    report = {
        "schema": "vaultsovereign.grok.verifier_report.v1",
